                                ...
                                <div class="col-md-12">
                                    <!--<form class="layui-form layui-form-pane" action="">
                                        <div class="form-group form-inline">
                                            <label for="inlineinput" class="col-md-2 col-form-label">*目录名称：</label>
                                            <div class="col-md-5 p-0">
                                                <input lay-verify="required" type="text" class="form-control input-full"
                                                       id="dname"
                                                       name="dname"
                                        ...
                                        <div class="form-group form-inline">
                                            <label for="inlineinput" class="col-md-2 col-form-label">同级目录排序：</label>
                                            <div class="col-md-5 p-0">
                                        ...
                                        <div class="form-group form-inline">
                                            <label for="inlineinput"
                                                   class="col-md-2 col-form-label">*所在父级目录：</label>
                                            <div class="col-md-5 p-0">
                                                <select lay-verify="myVerify" name="did" lay-filter="did" id="did">
                                                </select>
                                            </div>
                                        </div>
