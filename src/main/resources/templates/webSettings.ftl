                                    ...
                                    <div class="col-md-6">
                                        <form class="layui-form layui-form-pane" action="">
                                            <div class="form-group form-inline">
                                                <label for="inlineinput" class="col-md-3 col-form-label">网站状态 ：</label>
                                            ...
                                            <div class="form-group form-inline">
                                                <label for="inlineinput" class="col-md-3 col-form-label">网站标题：</label>
                                                <div class="col-md-9 p-0">
                                                    <input type="text" class="form-control input-full" id="title"
                                                           name="title" value="${(webSetting.title)!}">
                                                </div>
                                            </div>
                                            <div class="form-group form-inline">
                                                <label for="inlineinput" class="col-md-3 col-form-label">网站域名：</label>
                                                <div class="col-md-9 p-0">
                                                    <input type="text" class="form-control input-full" id="domain"
                                                           name="domain" value="${(webSetting.domain)!}">
                                                </div>
                                            </div>
                                            <div class="form-group form-inline">
                                                <label for="inlineinput" class="col-md-3 col-form-label">网站logo
                                                    ：</label>
                                                <div class="col-md-9 p-0">
                                                    <input type="hidden" id="logoData" name="logo">
                                                    <img width="200px" id="logo" height="150px" src="${(webSetting.logo)!}">
                                                </div>
                                            </div>
                                            <div class="form-group form-inline">
                                                <label for="inlineinput" class="col-md-3 col-form-label">公司邮箱 ：</label>
                                                <div class="col-md-9 p-0">
                                                    <input type="text"
                                                           class="form-control input-full" id="email" name="email"
                                                           value="${(webSetting.email)!}">
                                                </div>
                                            </div>
                                            <div class="form-group form-inline">
                                                <label for="description"
                                                       class="col-md-3 col-form-label">站点语言：</label>
                                                <div class="col-md-9 p-0">
    ...
    layui.use(['form', 'upload'], function () {
        ...
        var uploadInst = upload.render({
            ...
            , done: function (res) {
                if (res.code === 0) {
                    layer.alert("上传成功");
                    document.getElementById("logoData").value = res.data;
                    document.getElementById("logo").src = res.data;
                } else {
                    layer.alert("上传失败");
                }
            }
